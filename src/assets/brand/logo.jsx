export const logo = [
  ...
  `<g>
    <g fill="none" fill-rule="nonzero">
      ...
      <text x="130" y="75" font-family="Arial, sans-serif" font-weight="bold" font-size="48" style="fill:currentColor;">CoreUI</text>
      <text x="340" y="75" font-family="Arial, sans-serif" font-weight="bold" font-size="48" style="fill:#80d0ff;">Next.js</text>
    </g>
  </g>`,
]
